...
/* Install SWI/IRQ handler */
#define VEC_OFFSET      0x00000fff
#define VEC_LDR_PC      0xfffff000
#define VEC_POSITIVE    0xe59ff000
#define VEC_NEGATIVE    0xe51ff000
#define VEC_LOAD_HDLR   0xe51ff004
